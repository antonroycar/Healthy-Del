...
class PegawaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'harimulai' => 'required|min:1',
            'hariakhir' => 'required|min:1',
            'jammulai' => 'required|min:1',
            'jamakhir' => 'required|min:1',
        ...
        $pegawai->harimulai = $request->harimulai;
        $pegawai->hariakhir = $request->hariakhir;
        $pegawai->jammulai = $request->jammulai;
        $pegawai->jamakhir = $request->jamakhir;
