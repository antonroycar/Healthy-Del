        ...
        <div class="row align-items-start">
              ...
              <table>
                ...
                <p style="padding-top:20px">Benar sakit pada tanggal {{ date('j F Y', strtotime($surat->tanggal)) }} dengan diagnosa <span style="text-decoration-line:underline"><b>{{ $surat->diagnosa }}</b></span>. Mengingat kesehatannya, diajurkan istirahat
                  ...
                  <div style="width: 89%; text-align: right; float: left;">Dokter yang memeriksa</div>
                  <br>
                  <br>
                  <br>
                  <br>
                  <br>
                  <div style="width: 90%; text-align: right; float: left;">dr. Togumananta Naipospos</div>
                  

                  
                </div>
              <div>
                <button class="btn btn-info btn-sm" onclick="myFunction()">Prints</button>
